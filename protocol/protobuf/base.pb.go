...
func file_steammessages_base_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_steammessages_base_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*CMsgKubeRPCPacket); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_steammessages_base_proto_msgTypes[21].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*CMsgKubeRPCPacket_Hdr); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_steammessages_base_proto_msgTypes[22].Exporter = func(v interface{}, i int) interface{} {
