...
func file_steammessages_clientserver_friends_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_steammessages_clientserver_friends_proto_msgTypes[36].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*CMsgClientPersonaState_Friend_OtherGameData); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_steammessages_clientserver_friends_proto_msgTypes[39].Exporter = func(v interface{}, i int) interface{} {
