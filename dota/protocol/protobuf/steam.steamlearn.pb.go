...
const file_steammessages_steamlearn_steamworkssdk_proto_rawDesc = "" +
	"\n" +
	",steammessages_steamlearn.steamworkssdk.proto\x1a.steammessages_unified_base.steamworkssdk.proto\"f\n" +
	"\"CMsgSteamLearnDataSourceDescObject\x12@\n" +
	"\belements\x18\x01 \x03(\v2$.CMsgSteamLearnDataSourceDescElementR\belements\"\xdc\x01\n" +
	"#CMsgSteamLearnDataSourceDescElement\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12N\n" +
	"\tdata_type\x18\x02 \x01(\x0e2\x14.ESteamLearnDataType:\x1bSTEAMLEARN_DATATYPE_INVALIDR\bdataType\x12;\n" +
	"\x06object\x18\x03 \x01(\v2#.CMsgSteamLearnDataSourceDescObjectR\x06object\x12\x14\n" +
	"\x05count\x18\x04 \x01(\rR\x05count\"\xa5\x02\n" +
	...
	"\x16cache_duration_seconds\x18\a \x01(\rR\x14cacheDurationSeconds\"R\n" +
	"\x18CMsgSteamLearnDataObject\x126\n" +
	"\belements\x18\x01 \x03(\v2\x1a.CMsgSteamLearnDataElementR\belements\"\xf1\x01\n" +
	...
	"\fdata_objects\x18\x18 \x03(\v2\x19.CMsgSteamLearnDataObjectR\vdataObjects\"\x8a\x01\n" +
	...
	"\x04data\x18\x01 \x03(\v2\x13.CMsgSteamLearnDataR\x04data\"\x8a\x01\n" +
	")CMsgSteamLearn_RegisterDataSource_Request\x12!\n" +
	"\faccess_token\x18\x01 \x01(\tR\vaccessToken\x12:\n" +
	"\vdata_source\x18\x03 \x01(\v2\x19.CMsgSteamLearnDataSourceR\n" +
	"dataSource\"\xd5\x01\n" +
	"*CMsgSteamLearn_RegisterDataSource_Response\x12k\n" +
	"\x06result\x18\x01 \x01(\x0e2%.ESteammLearnRegisterDataSourceResult:,STEAMLEARN_REGISTER_DATA_SOURCE_RESULT_ERRORR\x06result\x12:\n" +
	"\vdata_source\x18\x02 \x01(\v2\x19.CMsgSteamLearnDataSourceR\n" +
	"dataSource\"n\n" +
	" CMsgSteamLearn_CacheData_Request\x12!\n" +
	"\faccess_token\x18\x01 \x01(\tR\vaccessToken\x12'\n" +
	"\x04data\x18\x03 \x01(\v2\x13.CMsgSteamLearnDataR\x04data\"\x89\x01\n" +
	"!CMsgSteamLearn_CacheData_Response\x12d\n" +
	"\x11cache_data_result\x18\x01 \x01(\x0e2\x1b.ESteamLearnCacheDataResult:\x1bSTEAMLEARN_CACHE_DATA_ERRORR\x0fcacheDataResult\"\x91\x02\n" +
	...
	"\x1apending_data_limit_seconds\x18\x06 \x01(\rR\x17pendingDataLimitSeconds\"\x98\x01\n" +
	"'CMsgSteamLearn_SnapshotProject_Response\x12m\n" +
	"\x0fsnapshot_result\x18\x01 \x01(\x0e2!.ESteamLearnSnapshotProjectResult:!STEAMLEARN_SNAPSHOT_PROJECT_ERRORR\x0esnapshotResult\"\xa2\x02\n" +
	...
	"\x13inference_responses\x18\x03 \x03(\v2\".CMsgSteamLearn_Inference_ResponseR\x12inferenceResponses\"\xd3\x05\n" +
	"\x1aCMsgSteamLearnAccessTokens\x12H\n" +
	"!register_data_source_access_token\x18\x01 \x01(\tR\x1dregisterDataSourceAccessToken\x12i\n" +
	"\x18cache_data_access_tokens\x18\x02 \x03(\v20.CMsgSteamLearnAccessTokens.CacheDataAccessTokenR\x15cacheDataAccessTokens\x12{\n" +
	"\x1esnapshot_project_access_tokens\x18\x03 \x03(\v26.CMsgSteamLearnAccessTokens.SnapshotProjectAccessTokenR\x1bsnapshotProjectAccessTokens\x12h\n" +
	"\x17inference_access_tokens\x18\x04 \x03(\v20.CMsgSteamLearnAccessTokens.InferenceAccessTokenR\x15inferenceAccessTokens\x1a_\n" +
	...
	"\x05appid\x18\x01 \x01(\rR\x05appid\"\xca\x01\n" +
	"'CMsgSteamLearn_GetAccessTokens_Response\x12]\n" +
	"\x06result\x18\x01 \x01(\x0e2!.ESteamLearnGetAccessTokensResult:\"STEAMLEARN_GET_ACCESS_TOKENS_ERRORR\x06result\x12@\n" +
	"\raccess_tokens\x18\x02 \x01(\v2\x1b.CMsgSteamLearnAccessTokensR\faccessTokens\"\xd2\x03\n" +
	...
	"\fitem_scalars\x18\x05 \x03(\v20.CMsgInferenceIterateBeamSearch.CustomItemScalarR\vitemScalars\x12*\n" +
	...
	"\x05scale\x18\x02 \x01(\x02R\x05scale\"\xc0\x03\n" +
	...
	"\bfetch_id\x18\x02 \x01(\rR\afetchId\"\xb9\x18\n" +
	")CMsgSteamLearn_InferenceMetadata_Response\x12\x84\x01\n" +
	"\x19inference_metadata_result\x18\x01 \x01(\x0e2#.ESteamLearnInferenceMetadataResult:#STEAMLEARN_INFERENCE_METADATA_ERRORR\x17inferenceMetadataResult\x12P\n" +
	"\trow_range\x18\x02 \x01(\v23.CMsgSteamLearn_InferenceMetadata_Response.RowRangeR\browRange\x12H\n" +
	"\x06ranges\x18\x03 \x03(\v20.CMsgSteamLearn_InferenceMetadata_Response.RangeR\x06ranges\x12L\n" +
	"\bstd_devs\x18\x04 \x03(\v21.CMsgSteamLearn_InferenceMetadata_Response.StdDevR\astdDevs\x12^\n" +
	"\x0ecompact_tables\x18\x05 \x03(\v27.CMsgSteamLearn_InferenceMetadata_Response.CompactTableR\rcompactTables\x12a\n" +
	"\x0fsequence_tables\x18\t \x03(\v28.CMsgSteamLearn_InferenceMetadata_Response.SequenceTableR\x0esequenceTables\x12I\n" +
	"\x06kmeans\x18\x06 \x03(\v21.CMsgSteamLearn_InferenceMetadata_Response.KMeansR\x06kmeans\x12R\n" +
	"\bapp_info\x18\b \x03(\v27.CMsgSteamLearn_InferenceMetadata_Response.AppInfoEntryR\aappInfo\x12k\n" +
	"\x12snapshot_histogram\x18\a \x01(\v2<.CMsgSteamLearn_InferenceMetadata_Response.SnapshotHistogramR\x11snapshotHistogram\x1a<\n" +
	"\bRowRange\x12\x17\n" +
	...
	"\astd_dev\x18\x03 \x01(\x02R\x06stdDev\x1a\xb9\x04\n" +
	"\fCompactTable\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12e\n" +
	"\n" +
	"map_values\x18\x02 \x03(\v2F.CMsgSteamLearn_InferenceMetadata_Response.CompactTable.MapValuesEntryR\tmapValues\x12k\n" +
	"\fmap_mappings\x18\x03 \x03(\v2H.CMsgSteamLearn_InferenceMetadata_Response.CompactTable.MapMappingsEntryR\vmapMappings\x1aM\n" +
	"\x05Entry\x12\x14\n" +
	"\x05value\x18\x01 \x01(\rR\x05value\x12\x18\n" +
	"\amapping\x18\x02 \x01(\rR\amapping\x12\x14\n" +
	"\x05count\x18\x03 \x01(\x04R\x05count\x1aw\n" +
	"\x0eMapValuesEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\rR\x03key\x12S\n" +
	"\x05value\x18\x02 \x01(\v2=.CMsgSteamLearn_InferenceMetadata_Response.CompactTable.EntryR\x05value\x1ay\n" +
	"\x10MapMappingsEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\rR\x03key\x12S\n" +
	"\x05value\x18\x02 \x01(\v2=.CMsgSteamLearn_InferenceMetadata_Response.CompactTable.EntryR\x05value\x1a\xd9\x04\n" +
	"\rSequenceTable\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12f\n" +
	"\n" +
	"map_values\x18\x02 \x03(\v2G.CMsgSteamLearn_InferenceMetadata_Response.SequenceTable.MapValuesEntryR\tmapValues\x12l\n" +
	"\fmap_mappings\x18\x03 \x03(\v2I.CMsgSteamLearn_InferenceMetadata_Response.SequenceTable.MapMappingsEntryR\vmapMappings\x12\x1f\n" +
	"\vtotal_count\x18\x04 \x01(\x04R\n" +
	"totalCount\x1aG\n" +
	"\x05Entry\x12\x16\n" +
	"\x06values\x18\x01 \x03(\rR\x06values\x12\x10\n" +
	"\x03crc\x18\x02 \x01(\rR\x03crc\x12\x14\n" +
	"\x05count\x18\x03 \x01(\rR\x05count\x1ax\n" +
	"\x0eMapValuesEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\rR\x03key\x12T\n" +
	"\x05value\x18\x02 \x01(\v2>.CMsgSteamLearn_InferenceMetadata_Response.SequenceTable.EntryR\x05value\x1az\n" +
	"\x10MapMappingsEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12T\n" +
	"\x05value\x18\x02 \x01(\v2>.CMsgSteamLearn_InferenceMetadata_Response.SequenceTable.EntryR\x05value\x1a\x9c\x02\n" +
	"\x06KMeans\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12U\n" +
	"\bclusters\x18\x02 \x03(\v29.CMsgSteamLearn_InferenceMetadata_Response.KMeans.ClusterR\bclusters\x1a\xa6\x01\n" +
	"\aCluster\x12\f\n" +
	...
	"\tadult_sex\x18\a \x01(\bR\badultSex\x1aj\n" +
	"\fAppInfoEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\rR\x03key\x12H\n" +
	"\x05value\x18\x02 \x01(\v22.CMsgSteamLearn_InferenceMetadata_Response.AppInfoR\x05value\"\xe2\t\n" +
	"(CMsgSteamLearn_InferenceBackend_Response\x12J\n" +
	"\aoutputs\x18\x01 \x03(\v20.CMsgSteamLearn_InferenceBackend_Response.OutputR\aoutputs\x1a \n" +
	"\bSequence\x12\x14\n" +
	...
	"\x05value\x18\x01 \x01(\x02R\x05value\x1a\xa8\x01\n" +
	...
	"\x0evalue_sequence\x18\x03 \x03(\v22.CMsgSteamLearn_InferenceBackend_Response.SequenceR\rvalueSequence\x1a\xa8\x01\n" +
	"\x1dCategoricalCrossEntropyOutput\x12\x16\n" +
	"\x06weight\x18\x01 \x03(\x02R\x06weight\x12\x14\n" +
	"\x05value\x18\x02 \x03(\x02R\x05value\x12Y\n" +
	"\x0evalue_sequence\x18\x03 \x03(\v22.CMsgSteamLearn_InferenceBackend_Response.SequenceR\rvalueSequence\x1a\xe7\x04\n" +
	"\x06Output\x12u\n" +
	"\x13binary_crossentropy\x18\x01 \x01(\v2B.CMsgSteamLearn_InferenceBackend_Response.BinaryCrossEntropyOutputH\x00R\x12binaryCrossentropy\x12\x84\x01\n" +
	"\x18categorical_crossentropy\x18\x02 \x01(\v2G.CMsgSteamLearn_InferenceBackend_Response.CategoricalCrossEntropyOutputH\x00R\x17categoricalCrossentropy\x12\x85\x01\n" +
	"\x19multi_binary_crossentropy\x18\x03 \x01(\v2G.CMsgSteamLearn_InferenceBackend_Response.MutliBinaryCrossEntropyOutputH\x00R\x17multiBinaryCrossentropy\x12\\\n" +
	"\n" +
	"regression\x18\x04 \x01(\v2:.CMsgSteamLearn_InferenceBackend_Response.RegressionOutputH\x00R\n" +
	"regression\x12i\n" +
	"\x0fnamed_inference\x18\x05 \x01(\v2>.CMsgSteamLearn_InferenceBackend_Response.NamedInferenceOutputH\x00R\x0enamedInferenceB\x0e\n" +
	"\fResponseType\"\xf1\x01\n" +
	"!CMsgSteamLearn_Inference_Response\x12b\n" +
	"\x10inference_result\x18\x01 \x01(\x0e2\x1b.ESteamLearnInferenceResult:\x1aSTEAMLEARN_INFERENCE_ERRORR\x0finferenceResult\x12T\n" +
	...
	"5STEAMLEARN_INFERENCE_METADATA_ERROR_NO_FETCH_ID_FOUND\x10\a2\x93\n" +
	"\n" +
	"\n" +
	...
	"\x0eBatchOperation\x12&.CMsgSteamLearn_BatchOperation_Request\x1a'.CMsgSteamLearn_BatchOperation_Response\"W\x82\xb5\x18SBatches multiple data updates, snapshots, and inference requests into a single call\x12\xd8\x01\n" +
