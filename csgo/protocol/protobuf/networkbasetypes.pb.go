...
const file_networkbasetypes_proto_rawDesc = "" +
	"\n" +
	"\x16networkbasetypes.proto\x1a google.golang.org/protobuf/types/descriptorpb\x1a\x18network_connection.proto\"D\n" +
	"\n" +
	"CMsgVector\x12\f\n" +
	...
	"\x01y\x18\x02 \x01(\x02R\x01y\x12\f\n" +
	"\x01z\x18\x03 \x01(\x02R\x01z\x12\f\n" +
	"\x01w\x18\x04 \x01(\x02R\x01w\"\x81\x01\n" +
	"\rCMsgTransform\x12'\n" +
	"\bposition\x18\x01 \x01(\v2\v.CMsgVectorR\bposition\x12\x14\n" +
	"\x05scale\x18\x02 \x01(\x02R\x05scale\x121\n" +
	"\vorientation\x18\x03 \x01(\v2\x0f.CMsgQuaternionR\vorientation\"B\n" +
	"\bCMsgRGBA\x12\f\n" +
	...
	"\n" +
	"CEntityMsg\x12-\n" +
	"\rtarget_entity\x18\x01 \x01(\r:\b16777215R\ftargetEntity\"f\n" +
	"\n" +
	"CMsg_CVars\x12&\n" +
	"\x05cvars\x18\x01 \x03(\v2\x10.CMsg_CVars.CVarR\x05cvars\x1a0\n" +
	"\x04CVar\x12\x12\n" +
	...
	"\x0fprediction_sync\x18\x02 \x01(\rR\x0epredictionSync\"A\n" +
	"\x11CNETMsg_SetConVar\x12%\n" +
	"\aconvars\x18\x01 \x01(\v2\v.CMsg_CVarsR\aconvars:\x05\x80\xb5\x18\x80 \"\x8b\x02\n" +
	"\x13CNETMsg_SignonState\x12C\n" +
	"\fsignon_state\x18\x01 \x01(\x0e2\x0e.SignonState_t:\x10SIGNONSTATE_NONER\vsignonState\x12\x1f\n" +
	...
	"\x06addons\x18\x06 \x01(\tR\x06addons\"\xe1\x02\n" +
	"\x11CSVCMsg_GameEvent\x12\x1d\n" +
	"\n" +
	"event_name\x18\x01 \x01(\tR\teventName\x12\x18\n" +
	"\aeventid\x18\x02 \x01(\x05R\aeventid\x12,\n" +
	"\x04keys\x18\x03 \x03(\v2\x18.CSVCMsg_GameEvent.key_tR\x04keys\x1a\xe4\x01\n" +
	"\x05key_t\x12\x12\n" +
	...
	"\n" +
	"val_uint64\x18\b \x01(\x04R\tvalUint64\"\x9a\x01\n" +
	"\x16CSVCMsgList_GameEvents\x127\n" +
	"\x06events\x18\x01 \x03(\v2\x1f.CSVCMsgList_GameEvents.event_tR\x06events\x1aG\n" +
	"\aevent_t\x12\x12\n" +
	"\x04tick\x18\x01 \x01(\x05R\x04tick\x12(\n" +
	"\x05event\x18\x02 \x01(\v2\x12.CSVCMsg_GameEventR\x05event\"\x87\a\n" +
	...
	"\x15spawngroupownerhandle\x18\x05 \x01(\rR\x15spawngroupownerhandle\x125\n" +
	"\x10world_offset_pos\x18\x06 \x01(\v2\v.CMsgVectorR\x0eworldOffsetPos\x129\n" +
	"\x12world_offset_angle\x18\a \x01(\v2\v.CMsgQAngleR\x10worldOffsetAngle\x12.\n" +
	...
	"\flandmarkname\x18\x12 \x01(\tR\flandmarkname\"\xf6\x01\n" +
	"\x14CNETMsg_DebugOverlay\x12\x14\n" +
	"\x05etype\x18\x01 \x01(\x05R\x05etype\x12%\n" +
	"\avectors\x18\x02 \x03(\v2\v.CMsgVectorR\avectors\x12!\n" +
	"\x06colors\x18\x03 \x03(\v2\t.CMsgRGBAR\x06colors\x12\x1e\n" +
	"\n" +
