...
const file_econ_gcmessages_proto_rawDesc = "" +
	...
	"\n" +
	"extra_data\x18\x03 \x03(\x04R\textraData*\x83)\n" +
	"\n" +
	"EGCItemMsg\x12\x11\n" +
	...
	"\x1ek_EMsgGCUnlockCrate_DEPRECATED\x10\xef\a\x12 \n" +
	...
	"\x1ck_EMsgGCBackpackSortFinished\x10\xa2\b\x12\x18\n" +
	...
	"\x1fk_EMsgGCAdjustEquipSlotsShuffle\x10\xe4\x13\x12\x16\n" +
	"\x11k_EMsgGCOpenCrate\x10\xe6\x13\x12(\n" +
	"#k_EMsgGCAcknowledgeRentalExpiration\x10\xe7\x13\x12%\n" +
	" k_EMsgGCVolatileItemLoadContents\x10\xe8\x13*\xd5\x02\n" +
	...
	"%k_UnlockStyle_Failed_CantAffordAttrib\x10\x05*\xc7\f\n" +
	...
	"0k_EGCItemCustomizationNotification_RemoveSticker\x10\x9d\b\x126\n" +
	"1k_EGCItemCustomizationNotification_ExtractSticker\x10\x9e\b\x12:\n" +
	"5k_EGCItemCustomizationNotification_EncapsulateSticker\x10\x9f\b\x124\n" +
