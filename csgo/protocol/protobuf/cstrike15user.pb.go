...
const file_cstrike15_usermessages_proto_rawDesc = "" +
	...
	"\tfrom_hits\x18\x05 \x01(\x05R\bfromHits\"\x9a\x04\n" +
	...
	"\x05isbot\x18\b \x01(\bR\x05isbot:\x05\x80\xb5\x18\x80 \"\x9c\t\n" +
	...
	"\taim_punch\x18\b \x01(\v2\v.CMsgQAngleR\baimPunch\"a\n" +
	" CCSUsrMsg_RecurringMissionSchema\x12\x16\n" +
	"\x06period\x18\x01 \x01(\rR\x06period\x12%\n" +
	"\x0emission_schema\x18\x02 \x01(\fR\rmissionSchema\"\xfd\x01\n" +
	"\x1bCCSUsrMsg_SendPlayerLoadout\x12B\n" +
	"\aloadout\x18\x01 \x03(\v2(.CCSUsrMsg_SendPlayerLoadout.LoadoutItemR\aloadout\x12\"\n" +
	"\n" +
	"playerslot\x18\x02 \x01(\x05:\x02-1R\n" +
	"playerslot\x1an\n" +
	"\vLoadoutItem\x127\n" +
	"\tecon_item\x18\x01 \x01(\v2\x1a.CEconItemPreviewDataBlockR\beconItem\x12\x12\n" +
