...
const file_cstrike15_gcmessages_proto_rawDesc = "" +
	...
	"\x11active_section_id\x18\t \x01(\rR\x0factiveSectionId\"\xd0\x05\n" +
	...
	"\aentries\x18\x02 \x03(\v2\x1b.ScoreLeaderboardData.EntryR\aentries\"\xb6\x06\n" +
	...
	"\x0fuserstatchanges\x18\b \x03(\v2\x1c.CMsgCsgoSteamUserStatChangeR\x0fuserstatchanges\x1a\xf1\x02\n" +
	...
	"\fquest_period\x18\x06 \x01(\x05R\vquestPeriod\x12A\n" +
	"\n" +
	"quest_type\x18\a \x01(\x0e2\n" +
	".QuestType:\x16k_EQuestType_OperationR\tquestType\"\x95\b\n" +
	...
	"\x0epre_match_data\x18\x0f \x01(\v2\x12.CPreMatchInfoDataR\fpreMatchData\x12\x1d\n" +
	"\n" +
	...
	"\x13match_id_additional\x18\x16 \x01(\rR\x11matchIdAdditional\"\x91\a\n" +
	...
	"serverinfo\x12N\n" +
	"\x14match_end_quest_data\x18\x04 \x01(\v2\x1d.CMsgGC_ServerQuestUpdateDataR\x11matchEndQuestData\"\x95\t\n" +
	...
	"\tkeychains\x18\x14 \x03(\v2\".CEconItemPreviewDataBlock.StickerR\tkeychains\x12\x14\n" +
	"\x05style\x18\x15 \x01(\rR\x05style\x12B\n" +
	"\n" +
	"variations\x18\x16 \x03(\v2\".CEconItemPreviewDataBlock.StickerR\n" +
	"variations\x12#\n" +
	...
	"\x0fwrapped_sticker\x18\f \x01(\rR\x0ewrappedSticker\"l\n" +
	...
	"\vcampaign_id\x18\x01 \x01(\rB\x04\x80\xa6\x1d\x01R\n" +
	"campaignId\x12!\n" +
	"\tredeem_id\x18\x02 \x01(\rB\x04\x80\xa6\x1d\x01R\bredeemId\x12#\n" +
	...
	"\x06defidx\x18\x01 \x01(\rB\x04\x80\xa6\x1d\x01R\x06defidx\x12\x1f\n" +
	"\vfaux_itemid\x18\x02 \x03(\x04R\n" +
	"fauxItemid\x12'\n" +
	"\x0fgeneration_time\x18\x03 \x03(\rR\x0egenerationTime\"~\n" +
	"\x1dCSOVolatileItemClaimedRewards\x12\x1c\n" +
	"\x06defidx\x18\x01 \x01(\rB\x04\x80\xa6\x1d\x01R\x06defidx\x12\x16\n" +
	...
	"\rtime_play_ban\x18\x03 \x01(\rR\vtimePlayBan\"\x80\x02\n" +
	...
	"\bprogress\x18\x04 \x01(\rR\bprogress\"\xce\x01\n" +
	...
	"#CMsgRequestRecurringMissionSchedule\"\xc5\x01\n" +
	"\x1aCMsgRecurringMissionSchema\x12K\n" +
	"\bmissions\x18\x01 \x03(\v2/.CMsgRecurringMissionSchema.MissionTemplateListR\bmissions\x1aZ\n" +
